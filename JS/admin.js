...
function dispalyInformationAdminSinIn() {
    let laocalStorageAffic = JSON.parse(localStorage.getItem("adminInformation"));
    dispalyadmininfo(laocalStorageAffic)
    function dispalyadmininfo(information) {
        const admin_information_SinIN = document.getElementById("admin_information_SinIN")
         admin_information_SinIN.innerHTML = `
                <div>
                    <p><strong>nom:</strong>${information.adminName}</p>
                    <p><strong>Age:</strong>${information.adminAge}</p>
                </div>
                <div>
                    <p><strong>Telephone:</strong>${information.adminPhone}</p>
                    <p><strong>Email:</strong>${information.adminEmail}</p>
                </div>
                <div>
                    <p><strong>Campus:</strong>${information.adminCampus}</p>
                    <p><strong class="conacted"></strong>Connected</p>
                </div>
        `
    }
}
